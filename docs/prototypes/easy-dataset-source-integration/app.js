    ...
    <div class="cols">
      ...
      <div>
          ...
          <div class="card__body card__body--tight">
            <div class="srclist">
              <div class="src">
                ...
                <span class="src__name"><b>临床诊疗指南_2026修订版.pdf</b><small>章节感知递归分块 · 1.2–8.4 节</small></span>
              ...
              <div class="src">
                ...
                <span class="src__name"><b>用药规范_v5.docx</b><small>章节感知递归分块 · 全部</small></span>
              ...
              <div class="src">
                ...
                <span class="src__name"><b>典型病例集.md</b><small>固定长度分块 · 800/100</small></span>
        ...
        <div class="card mt-16">
          <div class="card__head"><h3>领域标签树</h3><span class="pill pill--mute">自动生成 · 可人工修正</span><div class="spacer"></div><button class="btn btn--sm">重新生成</button></div>
          <div class="card__body card__body--tight">
            <div class="tree">
              <div class="tree__row"><span class="tree__caret">▾</span><span class="tree__name"><b>内科</b></span><span class="tree__count">128 块</span></div>
              <div class="tree__row tree__row--l2"><span class="tree__caret">▾</span><span class="tree__name">心血管</span><span class="tree__count">46 块</span><span class="tree__badge">已关联</span></div>
              <div class="tree__row tree__row--l3"><span class="tree__caret"></span><span class="tree__name">高血压</span><span class="tree__count">22 块</span><span class="tree__badge">已关联</span></div>
              <div class="tree__row tree__row--l3"><span class="tree__caret"></span><span class="tree__name">冠心病</span><span class="tree__count">24 块</span><span class="tree__badge">已关联</span></div>
              <div class="tree__row tree__row--l2"><span class="tree__caret">▾</span><span class="tree__name">呼吸科</span><span class="tree__count">42 块</span><span class="tree__badge">已关联</span></div>
              <div class="tree__row tree__row--l2"><span class="tree__caret">▸</span><span class="tree__name">消化科</span><span class="tree__count">40 块</span><span class="pill pill--warn">未关联</span></div>
              <div class="tree__row"><span class="tree__caret">▾</span><span class="tree__name"><b>外科</b></span><span class="tree__count">62 块</span></div>
              <div class="tree__row tree__row--l2"><span class="tree__caret">▸</span><span class="tree__name">普外</span><span class="tree__count">38 块</span><span class="tree__badge">已关联</span></div>
      ...
      <div class="card inspector">
        ...
        <div class="card__body">
          <div class="field">
            ...
            <div class="select"><span>章节感知递归分块</span><span>▾</span></div>
            <p class="field__hint">按 Markdown 标题层级切分，保证单块语义完整。可选：递归分隔符 / 固定长度 / 代码感知。</p>
          </div>
          <div class="field">
            <div class="field-row">
              <div>
              ...
              <div>
                ...
                <div class="input input--num">1200</div>
              </div>
            </div>
            <p class="field__hint">超长块会被二次切分；过短块与相邻块合并。</p>
          </div>
          <div class="field">
...
<div class="main">
  ...
  <div class="content">
    ${projectHead()}
    ${pageHead('DESIGN / SOURCE / IMPORT', '导入外部产物', '把外部工具产出的中间产物接进来。只接收素材（切分块与标签），不接收成品问答对 —— 问题仍由本项目按覆盖与标准生成。')}
    ...
    <div class="cols--2" style="display:grid;gap:16px">
      <div>
        <div class="card">
          <div class="card__head"><h3>产物字段 → 本项目字段</h3><div class="spacer"></div><span class="pill pill--ok">${'<span class="pill__dot"></span>'}5/5 已映射</span></div>
          <div class="card__body card__body--tight">
            <table class="grid">
              <thead><tr><th>产物字段</th><th>类型</th><th>→ 本项目字段</th><th>说明</th></tr></thead>
              <tbody>
                <tr><td class="mono">chunks[].content</td><td>string</td><td class="mono">source_chunks.content</td><td>块正文（必填）</td></tr>
                <tr><td class="mono">chunks[].hash</td><td>string</td><td class="mono">source_chunks.content_hash</td><td>幂等去重依据</td></tr>
                <tr><td class="mono">chunks[].tagPath</td><td>string[]</td><td class="mono">source_chunks.tag_path</td><td>领域标签路径</td></tr>
                <tr><td class="mono">chunks[].summary</td><td>string</td><td class="mono">source_chunks.summary</td><td>可空</td></tr>
                <tr><td class="mono">tags[]</td><td>tree</td><td class="mono">source_chunks.tag_tree</td><td>一级/二级标签树</td></tr>
              </tbody>
            </table>
          </div>
        </div>
        ...
        <div class="card mt-16">
          ...
          <div class="card__body card__body--tight">
            <div class="src">
              ...
              <span class="src__name"><b>214 块结构完整</b><small>content / hash / tagPath 均非空</small></span>
            ...
            <div class="src">
              ...
              <span class="src__name"><b>3 块缺 tagPath</b><small>chunk#47, chunk#112, chunk#198</small></span>
            ...
            <div class="src">
              <span class="src__icon src__icon--zip">!</span>
              <span class="src__name"><b>2 块 hash 与既有版本重复</b><small>将跳过，不产生新块（内容 hash 幂等）</small></span>
      ...
      <div class="card inspector">
        ...
        <div class="card__body">
          ...
          <div class="field">
            ...
            <div class="select"><span>按 tagPath 自动匹配</span><span>▾</span></div>
            <p class="field__hint">匹配不到的方向会在覆盖矩阵中标记为缺口，需人工处理。</p>
          </div>
