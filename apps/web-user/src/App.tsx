            ...
            <div className="evidence-layout">
              ...
              <div className="ev-header">
                <div className="ev-header-left">
                  ...
                  <Text strong>数据工厂</Text>
                  <div className="ev-header-nav">
                    {visibleUserPages.slice(0, 5).map((page) => (
                      <button
                        key={page.route}
                        className={clsx('ev-header-nav-item', activeNav === page.route && 'active')}
              ...
              <div className="ev-body">
                <div className="ev-sidebar">
                  <div className="ev-sidebar-entry">
                    <Space wrap>
                  ...
                  <div className="ev-sidebar-footer">
                    <Card className="ev-sidebar-stats" bodyStyle={{ padding: 10 }}>
                      <div className="console-summary-grid">
                        <div className="console-summary-row"><span>任务总数</span><Text strong>{runtime?.datasetCount ?? 0}</Text></div>
                        <div className="console-summary-row"><span>等待任务数</span><Text strong>{runtime?.queueDepth ?? 0}</Text></div>
                      </div>
                ...
                {/* Main Content (max-width report style) */}
