  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          user ? (
            <div className="openstatus-layout">
              {/* OpenStatus Header */}
              <div className="os-header">
                <div className="os-header-left">
                  <Avatar color="blue" size="small">L</Avatar>
                  <span style={{ fontSize: 14, fontWeight: 700, letterSpacing: '-0.02em' }}>data.factory</span>
                  <Button theme="solid" type="primary" size="small" icon={<CirclePlus size={14} />} onClick={() => navigate('/console/planning')}>new task</Button>
                  <Button size="small" onClick={() => navigate('/console/tasks')}>my tasks</Button>
                </div>
                <div className="os-header-right">
                  <Tag color={isAdmin ? 'green' : 'blue'}>{isAdmin ? 'admin' : 'user'}</Tag>
              ...
              <div className="os-subnav">
                {visibleUserPages.map((page) => (
                  <button
                    key={page.route}
                    className={clsx('os-subnav-item', activeNav === page.route && 'active')}
              ...
              {/* Footer */}
              <div className="os-footer">data.factory // openstatus-style layout</div>
            </div>
          ) : (
