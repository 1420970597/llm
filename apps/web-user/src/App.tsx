  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          user ? (
            <div className="redash-layout">
              {/* Redash Dark Narrow Navbar */}
              <div className="rd-navbar">
                <div className="rd-brand">
                  <Avatar color="blue" size="small">L</Avatar>
                  <div className="rd-brand-text font-semibold text-sm" style={{ color: '#fff' }}>数据工厂</div>
                </div>
                ...
                <div className="rd-nav-create">
                  <Button theme="solid" type="primary" icon={<CirclePlus size={16} />} block onClick={() => navigate('/console/planning')}>
                    <span className="rd-nav-create-text">新建任务</span>
                  </Button>
                  <Button theme="borderless" block style={{ color: 'rgba(255,255,255,0.6)' }} onClick={() => navigate('/console/tasks')}>
                    <span className="rd-nav-create-text">我的任务</span>
                  </Button>
                </div>
                <div className="rd-nav-footer">
                  <div className="rd-nav-footer-stats">
                    <div className="console-summary-grid">
              ...
              <div className="rd-content-wrapper">
                <div className="rd-topbar">
                  <div className="rd-topbar-left">
                    <Button icon={<LayoutDashboard size={16} />} theme="borderless" size="small" onClick={() => setSidebarCollapsed((c) => !c)} />
                    <span>{visiblePages.find((page) => page.route === activeNav)?.caption ?? '任务推进与交付'}</span>
                  </div>
