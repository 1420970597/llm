  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          user ? (
            <div className="formbricks-layout">
              {/* Formbricks Sidebar */}
              <div className="fb-sidebar">
                <div className="fb-sidebar-brand">
                  <Avatar color="blue" size="small">L</Avatar>
                  <Text strong style={{ fontSize: 14 }}>数据工厂</Text>
                </div>
                <div className="fb-sidebar-env">当前环境：生产</div>
                ...
                <div className="fb-sidebar-footer">
                  <Card className="fb-sidebar-stats" bodyStyle={{ padding: 10 }}>
                    <div className="console-summary-grid">
                      <div className="console-summary-row"><span>任务总数</span><Text strong>{runtime?.datasetCount ?? 0}</Text></div>
                      <div className="console-summary-row"><span>等待中</span><Text strong>{runtime?.queueDepth ?? 0}</Text></div>
                    </div>
                  </Card>
                </div>
              </div>
