  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          user ? (
            {/* material-dashboard-react layout */}
            <div className="md-dashboard">
              <div className={clsx("md-sidenav", sidebarCollapsed && "mini")}>
                <div className="md-sidenav-brand">
                  <div className="md-sidenav-brand-icon">
                    <LayoutDashboard />
                  </div>
                  <span className="md-sidenav-brand-text">{runtime?.config?.title || 'AI Factory'}</span>
                </div>
                <div className="md-sidenav-nav">
                  {[
                    ...
                    <div
                      key={item.key}
                      className={clsx("md-nav-item", activeNav === item.key && "active")}
                      onClick={() => navigate(item.path)}
                    >
                      <div className="md-nav-item-icon">
              ...
              <div className="md-main" style={{ marginLeft: sidebarCollapsed ? 104 : 282 }}>
                <div className="md-topnav">
                  <div className="md-topnav-left">
                    <div className="md-toggle-btn" onClick={() => setSidebarCollapsed(!sidebarCollapsed)}>
                      <ChevronRight style={{ transform: sidebarCollapsed ? 'rotate(0deg)' : 'rotate(180deg)', transition: 'transform 0.3s' }} />
                    </div>
                    <div>
                      <div className="md-topnav-breadcrumb">Pages / {activeNav || 'Dashboard'}</div>
                      <div className="md-topnav-title">{activeNav || 'Dashboard'}</div>
                    </div>
                  </div>
                  <div className="md-topnav-right">
                    <Button icon={<RefreshCw size={14} />} theme="borderless" size="small" />
                    <div className="md-toggle-btn" onClick={() => {
                    ...
                    <Avatar size="small" style={{ backgroundColor: '#1A73E8', cursor: 'pointer' }}>
