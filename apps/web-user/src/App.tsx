  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          user ? (
            <div className="calcom-layout">
              {/* Cal.com Shell Header */}
              <div className="cc-shell-header">
                <div className="cc-shell-header-left">
                  <Avatar color="blue" size="small">L</Avatar>
                  <Text strong style={{ fontSize: 15 }}>数据工厂</Text>
                  <div className="cc-shell-nav">
                    {visibleUserPages.map((page) => (
                      <button
                        key={page.route}
                        className={clsx('cc-shell-nav-item', activeNav === page.route && 'active')}
                        onClick={() => navigate(page.route)}
                      >
                        {page.label}
                      </button>
                    ))}
                    {isAdmin ? adminPages.slice(0, 2).map((page) => (
                      <button
                        key={page.route}
                        className={clsx('cc-shell-nav-item', activeNav === page.route && 'active')}
                        onClick={() => navigate(page.route)}
                ...
                <div className="cc-shell-header-right">
              ...
              <div className="cc-body">
                ...
                <div className="cc-sidebar">
                  ...
                  <div className="cc-sidebar-footer">
                    <Card className="cc-sidebar-stats" bodyStyle={{ padding: 10 }}>
                      <div className="console-summary-grid">
                        <div className="console-summary-row"><span>任务总数</span><Text strong>{runtime?.datasetCount ?? 0}</Text></div>
                        <div className="console-summary-row"><span>等待任务数</span><Text strong>{runtime?.queueDepth ?? 0}</Text></div>
                      </div>
