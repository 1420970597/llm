  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          user ? (
            {/* vue-element-admin layout */}
            <div className="vea-wrapper">
              <div className={clsx("vea-sidebar", sidebarCollapsed && "collapsed")}>
                <div className="vea-sidebar-logo">
                  <div className="vea-sidebar-logo-icon">
                    <LayoutDashboard />
                  </div>
                  <span className="vea-sidebar-logo-text">{runtime?.config?.title || 'AI Factory'}</span>
                </div>
                <div className="vea-sidebar-menu">
                  {[
                    ...
                    <div
                      key={item.key}
                      className={clsx("vea-menu-item", activeNav === item.key && "active")}
              ...
              <div className="vea-main-container" style={{ marginLeft: sidebarCollapsed ? 54 : 210 }}>
                <div className="vea-fixed-header">
                  <div className="vea-navbar">
                    <div className="vea-navbar-left">
                      <div className="vea-hamburger" onClick={() => setSidebarCollapsed(!sidebarCollapsed)}>
                        <ChevronRight style={{ transform: sidebarCollapsed ? 'rotate(0deg)' : 'rotate(180deg)', transition: 'transform 0.28s' }} />
                      </div>
                      <div className="vea-breadcrumb">
                        <span>Console</span>
                        <ChevronRight size={14} />
                        <span className="vea-breadcrumb-item">{activeNav || 'Home'}</span>
                      </div>
                    </div>
                    <div className="vea-navbar-right">
                      <Button icon={<RefreshCw size={14} />} theme="borderless" size="small" />
                      <div className="vea-user-dropdown" onClick={() => {
                        ...
                        <span className="vea-user-name">{user?.username || 'User'}</span>
                      </div>
                    </div>
                  </div>
                  <div className="vea-tags-view">
                    <div className={clsx("vea-tag-item", activeNav === 'home' && "active")} onClick={() => navigate('/console/home')}>
                      Dashboard
                    </div>
                    {activeNav && activeNav !== 'home' && (
                      <div className="vea-tag-item active">
                        {activeNav}
                      </div>
                    )}
                  </div>
                </div>
                <div className="vea-content">
                  <Routes>
