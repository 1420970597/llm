        ...
        element={
          user ? (
            <div className="saas-shell">
              ...
              <header className="saas-topbar">
                <div className="saas-topbar-inner">
                  <div className="saas-topbar-brand">
                    <Avatar color="blue" size="small" style={{ borderRadius: 8 }}>L</Avatar>
                    <span className="saas-brand-name">企业数据工厂</span>
                    <Tag color={isAdmin ? 'green' : 'blue'} style={{ marginLeft: 8 }}>{isAdmin ? '管理员' : '普通用户'}</Tag>
                  </div>
                  <nav className="saas-topnav">
                    {visibleUserPages.map((page) => (
                      <button
                        key={page.route}
                        className={clsx('saas-topnav-item', activeNav === page.route && 'saas-topnav-item--active')}
                    ...
                    {isAdmin && adminPages.map((page) => (
                      <button
                        key={page.route}
                        className={clsx('saas-topnav-item saas-topnav-item--admin', activeNav === page.route && 'saas-topnav-item--active')}
                        onClick={() => navigate(page.route)}
                      >
                        <page.icon size={14} />
                        <span>{page.label}</span>
                  ...
                  <div className="saas-topbar-actions">
                    ...
                    <Text className="saas-user-email">{user.email}</Text>
              ...
              {/* SaaS Stat Bar */}
              <div className="saas-statbar">
                <div className="saas-stat-item">
                  <span className="saas-stat-value">{runtime?.datasetCount ?? 0}</span>
                  <span className="saas-stat-label">任务总数</span>
                </div>
                <div className="saas-stat-item">
                  <span className="saas-stat-value">{runtime?.queueDepth ?? 0}</span>
                  <span className="saas-stat-label">队列深度</span>
                </div>
                <div className="saas-stat-item">
                  <span className="saas-stat-value">{dashboard?.activeProviderCount ?? 0}</span>
                  <span className="saas-stat-label">AI 服务</span>
                </div>
                <div className="saas-stat-item">
                  <span className="saas-stat-value">{dashboard?.artifactCount ?? 0}</span>
                  <span className="saas-stat-label">交付文件</span>
                </div>
              </div>
